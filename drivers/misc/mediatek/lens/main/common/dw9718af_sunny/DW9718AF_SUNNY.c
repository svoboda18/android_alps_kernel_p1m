...
#define AF_DRVNAME "DW9718AF_SUNNY_DRV"
...
static inline int getAFInfo(__user struct stAF_MotorInfo *pstMotorInfo)
{
	...
	if (copy_to_user(pstMotorInfo, &stMotorInfo, sizeof(*pstMotorInfo)))
...
/* ////////////////////////////////////////////////////////////// */
long DW9718AF_SUNNY_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	long i4RetValue = 0;
...
int DW9718AF_SUNNY_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
int DW9718AF_SUNNY_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
